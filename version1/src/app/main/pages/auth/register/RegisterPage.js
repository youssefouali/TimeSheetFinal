...
const schema = yup.object().shape({
  ...
  birthday: yup.string().required('You must enter your birthday'),
  tel: yup.string().required('You must enter your telephone number'),
  category: yup.string().required('You must enter your categoty are you an admin or project manager or user'),
        ...
        <motion.div initial={{ opacity: 0, scale: 0.6 }} animate={{ opacity: 1, scale: 1 }}>
          <Card className="w-full max-w-384">
            <CardContent className="flex flex-col items-center justify-center p-16 sm:p-24 md:p-32">
              <img className="w-128 m-32" src="https://thumbs.dreamstime.com/b/user-profile-my-account-avatar-login-icon-man-male-face-smile-symbol-flat-vector-human-person-member-sign-user-profile-182815734.jpg" alt="logo" />
